...
namespace jsontestapp.Controllers
{
    ...
    {
        private readonly string _connectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=jsontest;Integrated Security=True;";
        ...
        {
            var (column, jsonPathParameter) = ToPathOrColumnPre2017<RowModel>(orderBy);
